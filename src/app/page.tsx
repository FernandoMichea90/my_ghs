...
export default function Home() {
  return (
    <main className="flex min-h-screen items-center justify-between text-gray-900 py-24 md:py-24 px-10 md:px-24">
      <div className="flex-1 p-4">
        ...
        <div className="flex space-x-4">
          <button className="bg-primary text-white py-2 px-4 rounded">Ingresar</button>
          <input className="border border-primary p-2 rounded" placeholder="Ingresar tu email" />
        </div>
      </div>
